...
//private PImage currentBlueHour;
    ...
    //CADRANs
    private float cadranDPosXA = 0;
    private float cadranDPosXB = 0;
    ...
    private PImage imgTerre, imgGrid, imgShadow, imgVoid,
            imgDemiCadranDA, imgDemiCadranDB, imgDemiCadranGB, imgDemiCadranGA,
    ...
    //SHAPES
    private PShape globe, gridSphere, blueSphere, redSphere;
    ...
    private PShape clockR, clockB, clockRtrait, clockBtrait, clockRneedle, clockBneedle;
...
void windowResized() {
  ...
  */
    ...
    public void setup() {
        ...
        //IMAGES LOADING/////////////////////////////////////////////////
        //DISCRET
        imgTerre = loadImage("EARTHplus2.png");

        //imgGrid = loadImage("GRID.png");
        imgShadow = loadImage("shadow.png");
        //imgVoid = loadImage("VOID.png");

        imgDemiCadranDA = loadImage("DemiCadranDA02.png");
        imgDemiCadranDB = loadImage("DemiCadranDB02.png");
        imgDemiCadranGB = loadImage("DemiCadranGB02.png");
        imgDemiCadranGA = loadImage("DemiCadranGA02.png");

        traitb = loadImage("TRAITb.png");
        traitr = loadImage("TRAITr.png");

        redColor = loadImage("redColor.png");
        blueColor = loadImage("blueColor.png");

        imgBlueMoon = loadImage("blueMoon.png");
        imgBlueSun = loadImage("blueSun.png");
        imgRedMoon = loadImage("redMoon.png");
        imgRedSun = loadImage("redSun.png");
        imgAiguilleRed = loadImage("aiguilleRed.png");
        imgAiguilleBlue = loadImage("aiguilleBlue.png");
        //

        //numbers
        for (int i = 0; i < totalnumbersImgs; i++) {
            numbersImgs[i] = loadImage("number" + i + ".png");
        }
        //redHours
        ...
        //richSound('soundBgBuzz', 'data/bgBuzz4.mp3');
        //SOUNDS LOADING////////////////////////////////////////////////END
        //sound code
        ...
        try {
            ...
            soundBgBuzz = context.getAssets().openFd("bgBuzz4.mp3");
    ...
    private void createTheShapes() {
        ...
        //clockRneedle = createShape(RECT, 200 / 2, 0, 363, 6);
        //clockRneedle.setTexture(imgAiguilleRed);
        clockRneedle = createShape();
        clockRneedle.beginShape();
        clockRneedle.texture(imgAiguilleRed);
        clockRneedle.ambient(redAmbient);
        //sunBlue.noStroke();
        clockRneedle.vertex(80, 3, 0, 0);
        clockRneedle.vertex(283, 3, 363, 0);
        clockRneedle.vertex(283, -3, 363, 6);
        clockRneedle.vertex(80, -3, 0, 6);
        clockRneedle.endShape(CLOSE);
        //
        ...
        //clockBneedle = createShape(RECT, 200 / 2, 0, 363, 6);
        //clockBneedle.setTexture(imgAiguilleBlue);
        clockBneedle = createShape();
        clockBneedle.beginShape();
        clockBneedle.texture(imgAiguilleBlue);
        clockBneedle.ambient(blueAmbient);
        //sunBlue.noStroke();
        clockBneedle.vertex(80, 3, 0, 0);
        clockBneedle.vertex(283, 3, 363, 0);
        clockBneedle.vertex(283, -3, 363, 6);
        clockBneedle.vertex(80, -3, 0, 6);
        clockBneedle.endShape(CLOSE);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public void draw() {
       ...
       //blendMode(BLEND);
        ...
        //image(richLogoImg, width - 156, height - 64);  // TODO load the damn image
        if (!mousePressed) {
            onWhat = onNOTHING;
        }
        if(!spinningDone) {
 ...
 */
   ...
   */
        ...
        for (int i = 0; i < 20; i++) {
            ...
            //redDotLength = 260; / 256
            //blueDotLength = 260; / 256
            //ellipse(0, 0, 5, 5);
    ...
    private void renderGlobe() {
        ...
        /////////////////////////////
        //textureMode(IMAGE);
        //ambient(255); // ambientMaterial(255);
        //normalMaterial();
        //texture(imgShadow);
        //texture(imgTerre);
        // if(preLoaded){
        ...
        //}
        //
        //ambient(255); // ambientMaterial(0, 0);
        //texture(imgGrid);
        //shape(gridSphere);
        //sphere(257); //>>>>>>>>>>>>>>>>>>>>>>>>>GRID
    ...
    private void renderCadran() {
        ...
        if (cadranDPosXA > 200) {
            ...
            for (float i = -45; i <= 45; i += 3.75f) {
                ...
                //
                rect(0, 0, cadranDPosXB, 2);
                popStyle();
                //
                if (blueHourAlpha == 0) {
                    pushStyle();
                    fill(128, ladderAlphaB);
                    rect(0, -2, cadranDPosXB, 2);
                    popStyle();
                }
